...
<body>
    ...
    <div class="content">
        ...
        <div class="bttnProductos">
            <a title="Ver todos los productos" href="https://ustoree.azurewebsites.net/restringido/centro_comercial/tiendas/productos/lista_productos.php?id=<?php echo $_GET['id']; ?>">Ver todos los productos</a>
        </div>
