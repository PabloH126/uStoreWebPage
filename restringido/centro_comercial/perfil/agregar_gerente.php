        ...
        <div class="lista">
            <form action="envio_gerente.php" method="post" enctype="multipart/form-data" class="form-tiendas">
                    ...
                    <div class="bttns">
                        ...
                        <div class="bttn" id="next">
                            <button id="finalBtn" type="button" class="bttn-next" data-item="6" data-to_item="7">
                                ...
                                <i class='bx bx-envelope bttn-next'></i>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="item" id="item-7">
                    ...
                    <div class="notas">
                        <span>* Se envió un código de confirmación a la dirección de correo electrónico proporcionada. En caso de no haberlo recibido, revisar carpeta de SPAM en su buzón</span><br>
