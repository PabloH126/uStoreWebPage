...
if (!isset($_POST['statusSolicitud']) || ($_POST['statusSolicitud'] != "activa" && $_POST['statusSolicitud'] != "rechazada" && $_POST['statusSolicitud'] != "completada" && $_POST['statusSolicitud'] != "cancelada"))
{
