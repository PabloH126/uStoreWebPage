			...
			<div class="lista" id="lista">
				...
				?>
						<div class="item solicitudesItem">
							...
							<p><button id="aprobar" data-solicitud-id="<?php echo $solicitud['idSolicitud']; ?>"><i style="color: green;" class='bx bxs-check-circle aprobar bttn_solicitudes'></i></button></p>
							<p><button id="rechazar" data-solicitud-id="<?php echo $solicitud['idSolicitud']; ?>"><i style="color: #d30303;" class='bx bxs-x-circle rechazar bttn_solicitudes'></i></button></p>
						</div>
				<?php
					}
				}
