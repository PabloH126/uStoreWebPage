		...
		<div class="final">
			...
			if(isset($_SESSION['UserType']) && $_SESSION['UserType'] == "Administrador")
			{
				...
				echo '<div class="bottn" id="tienda" title="Tiendas creadas">
						<a href="https://ustoree.azurewebsites.net/restringido/centro_comercial/lista_tiendas2.php?id="' . $_SESSION['idMall'] . '"><img src="https://ustoredata.blob.core.windows.net/webpage/nav/tienda_select.png"></a>
					  </div>';
			}
			else
			{
